...
<?php if ( current_user_can( 'edit_page', get_queried_object_id() ) ) : ?>
    <div class="admin-edit-link" style="margin: 20px 0;">
        <a href="<?php echo esc_url( get_edit_post_link( get_queried_object_id() ) ); ?>" style="color: #d35400; font-weight: bold;">
            Edit This Page
        </a>
    </div>
<?php endif; ?>
...
<section class="hero-section-advanced services-hero">
    ...
    <div class="container">
        <div class="hero-content">
            <?php
            // Output the page content so it can be edited from the admin
