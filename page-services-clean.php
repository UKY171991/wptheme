<?php
/**
 * Template Name: Clean Services Page
 */
get_header(); ?>
...
?>
                    <a href="#services-grid" class="btn-primary">Browse Services</a>
                    <a href="<?php echo esc_url(get_permalink(get_page_by_path('contact'))); ?>" class="btn-secondary">Get Quote</a>
                </div>
            </div>
        </div>
    </section>
