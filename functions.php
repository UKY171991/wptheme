...
function services_pro_scripts() {
    // GLOBAL STYLES: Single comprehensive CSS file for entire theme
    wp_enqueue_style('global-styles', get_template_directory_uri() . '/global-styles.css', array(), '2.0.0');
    ...
    wp_enqueue_script('services-pro-script', get_template_directory_uri() . '/js/script.js', array('jquery'), '2.0.0', true);
